...
<html>
    ...
    <nav class="navtop">
    	<div>
    		...
    		<h1> Pizzaria Dom Gois</h1>
            <a href="index.php"><i class="fas fa-home"></i>Inicio</a>
            <a href="index.php"><i class="fa-solid fa-pizza-slice"></i>Cardapio</a>
            <a href="index.php"><i class="fa-solid fa-phone"></i>Contato</a>
            ...
            <a href="index.php"><i class="fa-solid fa-address-card"></i>Sobre Nós</a>
